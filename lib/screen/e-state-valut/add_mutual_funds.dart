...
class AddMutualFundsPage extends StatefulWidget {
  MutualFunds data;
  final bool isForEdit;

  AddMutualFundsPage(this.data, this.isForEdit, {Key? key}) : super(key: key);

  @override
  BaseState<AddMutualFundsPage> createState() => _AddMutualFundsPageState();
}

class _AddMutualFundsPageState extends BaseState<AddMutualFundsPage> {
  bool _isLoading = false;
  bool isForEdit = false;
  bool isSubmitClick = false;
  var itemData = MutualFunds();
  ...
  {
    super.initState();
    isForEdit = (widget as AddMutualFundsPage).isForEdit;
    if (isForEdit)
    {
      itemData = (widget as AddMutualFundsPage).data;
  ...
  void addMoreViews(MutualFunds data)
  {
    setState(() {
  ...
  _saveDataCall(String data) async
  {
    ...
    final url = Uri.parse(API_URL_VAULT + saveMutualFunds);
