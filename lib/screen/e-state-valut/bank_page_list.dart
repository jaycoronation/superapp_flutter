...
class _BankListPageState extends BaseState<BankListPage> {
                            ...
                            children: [
                              ...
                              Positioned(
                                  ...
                                  child: InkWell(
                                    onTap: ()
                                    {
                                      _redirectAdd(FinancialInstitutionAccounts(),false);
                                    },
                                    child: Container(
                                    width: 48,
                                    height: 48,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(flex: 4, child: Text(
                          checkValidString(listData[index].bankName),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(flex: 4, child: Text(
                          checkValidString(listData[index].branch),
                          style: const TextStyle(color: black, fontSize: 16, fontWeight: FontWeight.w500),
                        )),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(flex: 4, child: Text(
                          checkValidString(listData[index].accountNumberAndType),
                          style: const TextStyle(color: black, fontSize: 16, fontWeight: FontWeight.w500),
                        )),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(flex: 4, child: Text(
                          checkValidString(listData[index].otherThanOwnName),
                          style: const TextStyle(color: black, fontSize: 16, fontWeight: FontWeight.w500),
                        )),
                      ],
                    ),
  ...
  Future<void> _redirectAdd(FinancialInstitutionAccounts listData, bool isFor) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AddBankPage(listData, isFor)),
    );
    print("result ===== $result");
    if (result == "success") {
      setState(() {
  ...
  _getApiData() async {
    ...
    final url = Uri.parse(API_URL_VAULT + bankList);
    ...
    var dataResponse = BankListResponse.fromJson(user);

    if (statusCode == 200 && dataResponse.success == 1)
    {
      try {
        if (dataResponse.financialInstitutionAccounts != null) {
          listData = dataResponse.financialInstitutionAccounts!;
          setState(() {
            _isLoading = false;
          });
        }
  ...
  void deleteListData(FinancialInstitutionAccounts data, int index) {
  ...
  void deleteData(int index) async {
    ...
    final url = Uri.parse(API_URL_VAULT + deleteBank);

    Map<String, String> jsonBody = {
      'financial_institution_account_id': listData[index].financialInstitutionAccountId.toString(),
    };
