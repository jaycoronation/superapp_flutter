...
class AddRealEstatePage extends StatefulWidget {
  ...
  AddRealEstatePage(this.data, this.isForEdit, {Key? key}) : super(key: key);

  @override
  BaseState<AddRealEstatePage> createState() => _AddInsurancePolicyPageState();
}

class _AddInsurancePolicyPageState extends BaseState<AddRealEstatePage> {
  bool _isLoading = false;
  bool isForEdit = false;
  bool isSubmitClick = false;
  var itemData = RealProperties();
  ...
  {
    super.initState();
    isForEdit = (widget as AddRealEstatePage).isForEdit;
    if (isForEdit)
    {
      itemData = (widget as AddRealEstatePage).data;
      itemData.typeOfPropertyController.text = checkValidString(itemData.typeOfProperty.toString().trim());
      ...
      itemData.loanController.text = checkValidString(itemData.loan.toString().trim());
      itemData.rentController.text = checkValidString(itemData.rent.toString().trim());
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: MyToolBar(pageName: isForEdit ? "Update Real Estate" : "Add Real Estate"),
          centerTitle: false,
          elevation: 0,
          backgroundColor: appBg,
        ),
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          cursorColor: black,
                          controller: listData[index].typeOfPropertyController,
                          onChanged: (text) {
                            setState(() {
                              listData[index].setTypeOfProperty = text;
                            });
                          },
                          decoration: InputDecoration(
                            labelText: 'Type of Property',
                            errorText: isSubmitClick
                                ? checkValidString(listData[index].typeOfProperty).isNotEmpty
                                    ? null
                                    : 'Type of Property Can\'t Be Empty'
                                : null,
                          ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          keyboardType: TextInputType.number,
                          cursorColor: black,
                          controller: listData[index].loanController,
                          onChanged: (text) {
                            setState(() {
                              listData[index].setLoan = text;
                            });
                          },
                          decoration: InputDecoration(
                            labelText: 'Loan',
                            errorText: isSubmitClick
                                ? checkValidString(listData[index].loan).isNotEmpty
                                ? null
                                : 'Loan Can\'t Be Empty'
                                : null,
                          ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          keyboardType: TextInputType.number,
                          cursorColor: black,
                          controller: listData[index].rentController,
                          onChanged: (text) {
                            setState(() {
                              listData[index].setRent = text;
                            });
                          },
                          decoration: InputDecoration(
                            labelText: 'Rent',
                            errorText: isSubmitClick
                                ? checkValidString(listData[index].rent).isNotEmpty
                                ? null
                                : 'Rent Can\'t Be Empty'
                                : null,
                          ),
  ...
  void addMoreViews(RealProperties data)
  {
    setState(() {
      data.setTypeOfProperty = checkValidString(itemData.typeOfProperty.toString().trim());
      data.setName = checkValidString(itemData.name.toString().trim());
      data.setLocation = checkValidString(itemData.location.toString().trim());
      ...
      data.setLoan = checkValidString(itemData.loan.toString().trim());
      data.setRent = checkValidString(itemData.rent.toString().trim());
  ...
  bool isValidData()
  {
    ...
    for (int i = 0; i < listData.length; i++)
    {
      ...
      if (checkValidString(itemData.typeOfProperty).isNotEmpty &&
          checkValidString(itemData.name).isNotEmpty &&
          ...
          checkValidString(itemData.loan).isNotEmpty &&
          checkValidString(itemData.purchasedOn).isNotEmpty &&
          checkValidString(itemData.rent).isNotEmpty &&
  ...
  _saveDataCall(String data) async
  {
    ...
    final url = Uri.parse(API_URL_VAULT + saveRealProperty);
  ...
  void lastInsertedModule() async {
    ...
    Map<String, String> jsonBody = {
      'module':(widget as AddRealEstatePage).isForEdit ? "edit-real_estate" : "add-real_estate",
